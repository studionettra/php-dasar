                        ...
                        ?>
                                <div class="col-md-4">
                                    ...
                                    <div class="card product-card h-100 shadow-sm">
                                        ...
                                        <div class="px-3 pb-4 d-flex justify-content-center gap-2">
...
<script>
    ...
    function renderCart() {
        ...
        // cart.forEach(function(items, index){}) same
    ...
    document.getElementById('btn-payment').addEventListener('click', (e) => {
        if (cart.length === 0) {
            ...
            //stopPropagation(); make modal don't show
            e.stopPropagation();
        }
    });
</script>